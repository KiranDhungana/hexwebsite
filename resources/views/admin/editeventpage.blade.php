...
<body>
   ...
   <div class="p-4 sm:ml-64">
    ...
    <div class="grid gap-6 mb-6 ">
        <div>
        <label for="Title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Registeration-Link:</label>
            <input  name="link" type="text" id="first_name" class="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" Registeration-Link" required>
        </div>
     </div>
